        ...
        <div class="col-md-12">
            <form action="update.php?id=<?= $task['id'];?>" method="post">
                <div class="form-group">
                    ...
                    <input class="form-control" id="exampleFormControlTextarea1" name="title" placeholder="Введите название" value="<?= $task['title']; ?>">
                </div>


                <div class="form-group">
                    <label for="exampleFormControlTextarea1">Content</label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="content" placeholder="Введите текст"><?= $task['content']; ?></textarea>
                </div>
                <div class="form-group">
